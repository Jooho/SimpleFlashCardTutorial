...
class QuestionFileTest {
    ...
    inner class `XLSFile`() {
        ...
        fun `Load xls file`() {
            ...
            // Test Scenario(When)
            var questionFile =
                QuestionFile("/home/jooho/StudioProjects/SimpleFlashCard/app/src/test/resources/quiz.xlsx")
    ...
    inner class `Topics`() {
        ...
        @Test
        @Deprecated("Now, this method add Topics to DB so this test method does not work anymore. Added Context to avoid errors")
...
//            val actualTopics: List<Topic> = questionFile.createTopics(questionFile.loadXLSFile(), 1)
//
//            // Expected result (assert)
